...
import classes from './CuisineScreen.module.css';
...
/* @figmaId 110:451 */
export const CuisineScreen: FC<Props> = memo(function CuisineScreen(props = {}) {
  return (
    <div className={`${resets.clapyResets} ${classes.root}`}>
      ...
      <div className={classes.tanzanian}>tanzanian</div>
      <div className={classes.kenyan}>kenyan</div>
      <div className={classes.gelato}>Gelato</div>
      <div className={classes.fishChips}>fish &amp;chips</div>
      <div className={classes.dumplings}>dumplings</div>
      <div className={classes.donuts}>donuts</div>
      <div className={classes.burritos}>Burritos</div>
      <div className={classes.burgers}>Burgers</div>
      <div className={classes.bevarages}>Bevarages</div>
      <div className={classes.chinese}>chinese</div>
      <div className={classes.internationals}>internationals</div>
      <div className={classes.iceCream}>Ice cream</div>
      <div className={classes.grills}>Grills</div>
      <div className={classes.fruits}>fruits</div>
      <div className={classes.fries}>Fries</div>
      <div className={classes.desert}>desert</div>
      <div className={classes.curry}>curry</div>
      <div className={classes.coffee2}>coffee</div>
      <div className={classes.chicken}>chicken</div>
      <div className={classes.cakes}>cakes</div>
      <div className={classes.bBQ}>BBQ</div>
      <div className={classes.america}>America</div>
      <div className={classes.africa}>Africa</div>
      <div className={classes.algeria}>Algeria</div>
      <div className={classes.acia}>Acia</div>
      <div className={classes.clearAll}>clear all</div>
      <div className={classes.cuisines2}>cuisines</div>
      ...
      <div className={classes.searchCuisines}>search cuisines</div>
      <div className={classes.search4}>
        <SearchIcon2 className={classes.icon45} />
      </div>
    </div>
  );
});
