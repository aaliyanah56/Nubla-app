...
import classes from './MartOrder.module.css';
...
/* @figmaId 110:205 */
export const MartOrder: FC<Props> = memo(function MartOrder(props = {}) {
  return (
    <div className={`${resets.clapyResets} ${classes.root}`}>
      ...
      <div className={classes._280}>
        <p className={classes.labelWrapper}>
          <span className={classes.label}>$</span>
          <span className={classes.label2}> 28.00</span>
        </p>
      </div>
      ...
      <div className={classes.mountainDew}>mountain dew</div>
      <div className={classes._80}>$8.00</div>
      ...
      <div className={classes._150}>
        <p className={classes.labelWrapper2}>
          ...
          <span className={classes.label5}>15.00</span>
        </p>
      </div>
      ...
      <div className={classes._50}>
        <p className={classes.labelWrapper3}>
          ...
          <span className={classes.label7}> 5</span>
          <span className={classes.label8}>.00</span>
        </p>
      </div>
